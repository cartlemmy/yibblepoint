<?php
    ...
    class iptc {
        ...
        function set($tag, $data) {
            $this->meta ["2#$tag"] = is_array($data) ? $data : array( $data );
            $this->hasmeta = true;
        }
        
        function get($tag, $retArray = false) {
            return isset($this->meta["2#$tag"]) ? ($retArray ? $this->meta["2#$tag"] : $this->meta["2#$tag"][0]) : false;
        }
